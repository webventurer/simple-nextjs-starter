...
export function parseMarkdownContent(
  ...
  React.Children.forEach(children, (child) => {
    ...
    const element = child as React.ReactElement<React.ComponentProps<"div">>;
    ...
    if (element.type === "a") {
      const anchorProps = element.props as React.ComponentProps<"a">;
      if (anchorProps?.href) {
...
function extractLinksFromParagraph(
  paragraph: React.ReactElement<React.ComponentProps<"p">>,
    ...
    if (React.isValidElement(child) && child.type === "a") {
      ...
      if (childProps?.href) {
        links.push({
          ...
          href: childProps.href as string,
        });
      }
    }
  });
